...
class AlterationTab extends StatefulWidget {
  _AlterationTab createState() => _AlterationTab();
}

class _AlterationTab extends State<AlterationTab> {
  ScrollController _scrollController;

  List allDescriptions1 = [
  ...
  void initState() {
    ...
    setState(() {
      description1 = allDescriptions1[0];
    });
  }
  ...
  changedesc() {
    ...
    print(value);
    setState(() {
      description1 = allDescriptions1[descIndex];
    });
  }
        ...
        Container(
          ...
          child: ListView(
            ...
            children: [
              ...
              getalterationCard(
                  'images/personlogo.png', '10', 'Party', 'Western'),
              SizedBox(
                width: 15.0,
              ),
              getalterationCard(
